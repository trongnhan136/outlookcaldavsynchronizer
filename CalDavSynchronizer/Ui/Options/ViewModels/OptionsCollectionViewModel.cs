        ...
        public void SetOptionsCollection(Contracts.Options[] value, Guid? initialSelectedProfileId = null)
        {
            ...
            if (_options.Count <= 0)
            {
                ...
                var option = new Contracts.Options
                {
                    ...
                    CalenderUrl = "https://global3.hanbiro.com:15201/steve@global3.hanbiro.com/calendar/",
                    UserName = "apple@global3.hanbiro.com",
                    Password = SecureStringUtility.ToSecureString("saobang1@"),
