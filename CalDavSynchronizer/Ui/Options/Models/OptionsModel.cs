...
namespace CalDavSynchronizer.Ui.Options.Models
{
    public class OptionsModel : ModelBase
    {
        ...
        public MappingConfigurationModel MappingConfigurationModelOrNull
        {
            ...
            set { CheckedPropertyChange(ref _mappingConfigurationModelOrNull, value); }
        }

        public bool IsActive
        {
            get { return _isActive; }
            set { CheckedPropertyChange(ref _isActive, value); }
        }
        ...
        public bool EnableChangeTriggeredSynchronization
        {
            ...
            set { CheckedPropertyChange(ref _enableChangeTriggeredSynchronization, value); }
        }
        ...
        public bool UseAccountPassword
        {
            ...
            set { CheckedPropertyChange(ref _useAccountPassword, value); }
        }
        ...
        public SynchronizationMode SynchronizationMode
        {
            ...
            set { CheckedPropertyChange(ref _synchronizationMode, value); }
        }

        public ConflictResolution Resolution
        {
            get { return _conflictResolution; }
            set { CheckedPropertyChange(ref _conflictResolution, value); }
        }

        public int SynchronizationIntervalInMinutes
        {
            get { return _synchronizationIntervalInMinutes; }
            set { CheckedPropertyChange(ref _synchronizationIntervalInMinutes, value); }
        }
        ...
        public int DaysToSynchronizeInThePast
        {
            ...
            set { CheckedPropertyChange(ref _daysToSynchronizeInThePast, value); }
        }

        public int DaysToSynchronizeInTheFuture
        {
            get { return _daysToSynchronizeInTheFuture; }
            set { CheckedPropertyChange(ref _daysToSynchronizeInTheFuture, value); }
        }

        public bool CloseConnectionAfterEachRequest
        {
            get { return _closeConnectionAfterEachRequest; }
            set { CheckedPropertyChange(ref _closeConnectionAfterEachRequest, value); }
        }

        public bool PreemptiveAuthentication
        {
            get { return _preemptiveAuthentication; }
            set { CheckedPropertyChange(ref _preemptiveAuthentication, value); }
        }
        ...
        public string ProxyUrl
        {
            ...
            set { CheckedPropertyChange(ref _proxyUrl, value); }
        }

        public string ProxyUserName
        {
            get { return _proxyUserName; }
            set { CheckedPropertyChange(ref _proxyUserName, value); }
        }

        public SecureString ProxyPassword
        {
            get { return _proxyPassword; }
            set { CheckedPropertyChange(ref _proxyPassword, value); }
        }
